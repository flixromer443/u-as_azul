   ...
   <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#">Agregar alumnos</a>
              </li>  
              <li class="nav-item">
...
<?php
  include("../../components/add_student_form.php");
?>
...
<!-- Bootstrap 4 -->
<script src="../../js/validacionAgregarAlumno.js"></script>
</body>
</html>